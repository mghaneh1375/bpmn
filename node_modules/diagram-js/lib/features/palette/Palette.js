...
Palette.prototype.trigger = function(action, event, autoActivate) {
  ...
  // if(domAttr(button, 'data-action') == "Create Popup") {
  ...
  // if(domAttr(button, 'data-action') == 'create.task') {
