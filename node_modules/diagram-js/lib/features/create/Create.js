...
export default function Create(
  ...
  function createVisual(shape) {
    ...
    if($("#lozi").attr('data-clicked') == 1 || $("#lozi").attr('data-clicked') == "1") {
      $("#lozi").attr('data-clicked', 0);
      shape.attach = $("#lozi").attr('data-text');
    }

    if($("#rectangle").attr('data-clicked') == 1 || $("#rectangle").attr('data-clicked') == "1") {
      $("#rectangle").attr('data-clicked', 0);
      shape.attach = $("#rectangle").attr('data-text');
    }

    if($("#ring").attr('data-clicked') == 1 || $("#ring").attr('data-clicked') == "1") {
      $("#ring").attr('data-clicked', 0);
      shape.attach = $("#ring").attr('data-text');
    }

    // hijack renderer to draw preview
    graphicsFactory.drawShape(visual, shape);
    // $("#wqewq").innerHTML = 'salam';
    return group;
  }
