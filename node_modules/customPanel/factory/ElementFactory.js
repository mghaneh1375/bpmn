...
export function textBox2(options) {
    ...
    resource.html =
        '<label for="' + resource.id + '" ' +
        // (canBeShown ? 'data-show="isShown"' : '') +
        '>' + label + '</label><button style="margin-right: 10px" class="btn btn-warning" onclick="showPopupSelect(\'' + resource.placeHolder + '\', \'' + resource.id + '\')">انتخاب</button>' +
...
export function textBoxWithOutCondition(options) {
    ...
    resource.html =
        '<label for="' + resource.id + '" ' +
        // (canBeShown ? 'data-show="isShown"' : '') +
        '>' + label + '</label><button style="margin-right: 10px" class="btn btn-warning" onclick="showPopupSelect2(\'' + resource.id + '\')">انتخاب</button>' +
        '<div class="bpp-field-wrapper row" ' +
        // (canBeShown ? 'data-show="isShown"' : '') +
        '>' +
