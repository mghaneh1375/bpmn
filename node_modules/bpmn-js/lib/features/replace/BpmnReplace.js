  ...
  function replaceElement(element, target, hints) {
    ...
    if (is(oldBusinessObject, 'bpmn:Participant')) {
      ...
      if (target.isExpanded === true) {
        ...
        newBusinessObject.hidden = true;

        for(var t = 0; t < element.children.length; t++) {
          element.children[t].hidden = true;
        }
    ...
    for(var k in oldBusinessObject.$attrs) {
      newBusinessObject.$attrs[k] = oldBusinessObject.$attrs[k];
    }
    ...
    for (var r = 0; r < newElement.children.length; r++) {
      // alert(element.children[r].id);
      newElement.children[r].hidden = false;
    }

    newElement.order = undefined;
