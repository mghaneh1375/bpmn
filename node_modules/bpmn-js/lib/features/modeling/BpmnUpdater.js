...
BpmnUpdater.prototype.getLaneSet = function(container) {
  ...
  if(is(container, 'bpmn:Collaboration')) {

    var particips = container.participants;
    for(var i = 0; i < particips.length; i++) {
        if(particips[i].id == 'Participant_154yja4') {
          container = particips[i].processRef;
          break;
        }
    }
  }
  ...
  laneSet = (laneSets !== undefined && laneSets != null && laneSets.length > 0) ? laneSets[0] : false;
